...
Route::post('/backoffice/login',  [AuthController::class, 'login'])->middleware('throttle:5,1');
...
Route::middleware(['backoffice.auth'])->group(function () {
    ...
    Route::get('/backoffice/statistik',     [BackofficeController::class, 'aboutUs']);
...
*/
    ...
    Route::post('/backoffice/program-category/{id}/update', [BackofficeController::class, 'programCategoryUpdate']);
    ...
    // Partners
    Route::get('/backoffice/partner',               [BackofficeController::class, 'partner']);
    Route::post('/backoffice/partner/store',        [BackofficeController::class, 'partnerStore']);
    Route::post('/backoffice/partner/{id}/update',  [BackofficeController::class, 'partnerUpdate']);
    Route::post('/backoffice/partner/{id}/delete',  [BackofficeController::class, 'partnerDestroy']);
