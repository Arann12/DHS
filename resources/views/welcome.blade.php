        ...
        <div class="relative z-20 px-6 max-w-4xl mx-auto mt-20">
            ...
            <div class="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
                ...
                <a class="px-8 py-4 bg-dhs-navy text-white text-sm font-bold tracking-widest uppercase hover:bg-dhs-darknavy transition-colors rounded-md"
                    href="{{ $heroCta1Link }}"><span data-id="{{ $heroCta1Text }}" data-en="{{ $heroCta1Text }}">{{ $heroCta1Text }}</span></a>
                <a class="px-8 py-4 bg-white/20 backdrop-blur-sm text-white text-sm font-bold tracking-widest uppercase border border-white/40 hover:bg-white/30 transition-colors rounded-md"
                    href="{{ $heroCta2Link }}"><span data-id="{{ $heroCta2Text }}" data-en="{{ $heroCta2Text }}">{{ $heroCta2Text }}</span></a>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 md:gap-24">
            ...
            <div class="grid grid-cols-2 gap-6 content-center">
                ...
                <div class="bg-background-light p-6 flex flex-col justify-between h-56 transition-transform hover:-translate-y-1 duration-300 shadow-sm card-hover"
                    ...
                    <div>
                        <h4 class="font-bold text-sm mb-1 text-text-light" data-id="{{ $val['title'] ?? '' }}">{{ $val['title'] ?? '' }}</h4>
                        <p class="text-[0.7rem] text-muted-light leading-relaxed" data-id="{{ $val['desc'] ?? '' }}">{{ $val['desc'] ?? '' }}</p>
                    </div>
                </div>
                @endforeach
            </div>
    ...
    <section class="py-12 bg-white px-6 md:px-16">
        <div class="max-w-7xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <img alt="{{ $foto['alt'] ?? 'Foto Kampus' }}" class="w-full h-[400px] object-cover shadow-sm" data-reveal="zoom-up"
                    data-delay="{{ ($idx + 1) * 150 }}"
                    src="{{ $foto['src'] ?? '' }}">
                @endforeach
            </div>
        </div>
    ...
    <section class="py-24 bg-dhs-lightblue">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="border border-black/10 group cursor-pointer bg-white shadow-sm transition-shadow duration-300 hover:shadow-md card-hover"
                ...
                <div class="p-8">
                    <h3 class="text-2xl font-serif mb-4 text-text-light"><span data-id="{{ $card['title'] ?? '' }}">{{ $card['title'] ?? '' }}</span></h3>
                    ...
                    <a class="label-text text-xs border-b border-text-light/30 pb-1 hover:text-primary transition-colors"
                        href="{{ $card['link'] ?? '/akademi' }}"><span data-id="DETAIL PROGRAM" data-en="PROGRAM DETAILS">DETAIL PROGRAM</span></a>
                </div>
            </div>
            @endforeach
        </div>
    ...
    <section class="py-24 px-6 md:px-16 max-w-7xl mx-auto border-t border-black/10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="md:col-span-2 relative h-[500px] md:h-[600px] group overflow-hidden" data-reveal="fade-right">
                ...
                <div class="absolute bottom-6 left-6 bg-black/60 backdrop-blur-sm px-4 py-2 text-white text-xs uppercase tracking-wider" data-id="{{ $facilitiesItems[0]['label'] ?? '' }}">{{ $facilitiesItems[0]['label'] ?? '' }}</div>
            </div>
            @endif
            ...
            <div class="flex flex-col gap-6 h-[500px] md:h-[600px]" data-reveal="fade-left" data-delay="200">
                ...
                <div class="relative h-1/2 group overflow-hidden">
                    <img alt="{{ $fac['label'] ?? 'Fasilitas' }}"
                        class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105"
                        src="{{ $fac['image'] ?? '' }}">
                    <div class="absolute bottom-6 left-6 bg-black/60 backdrop-blur-sm px-4 py-2 text-white text-xs uppercase tracking-wider" data-id="{{ $fac['label'] ?? '' }}">{{ $fac['label'] ?? '' }}</div>
                </div>
                @endforeach
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto grid md:grid-cols-2 gap-16 md:gap-24">
            <div class="text-text-light" data-reveal="fade-right">
                ...
                <div class="space-y-8">
                    ...
                    {{-- Quick WA button --}}
                    <div class="pt-2">
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $contactDenpasarWa) }}"
                            target="_blank"
