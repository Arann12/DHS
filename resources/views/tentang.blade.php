        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            <div data-reveal="fade-right">
                <span class="text-[0.7rem] uppercase tracking-[0.15em] font-semibold text-primary mb-4 block">
                    <span data-id="{{ $introLabel }}" data-en="{{ $introLabel }}">{{ $introLabel }}</span>
                </span>
    ...
    <section class="bg-white py-20 md:py-24 px-5 md:px-16 max-w-[1280px] mx-auto border-t border-black/5">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12 items-center">
            <div class="md:col-span-1" data-reveal="fade-right">
                <img class="w-full h-auto object-cover border border-black/10" alt="{{ $leaderName }}"
                    src="{{ $directorPhoto }}">
            </div>
            <div class="md:col-span-2 text-text-light" data-reveal="fade-left" data-delay="200">
                ...
                <div class="text-base text-muted-light leading-relaxed space-y-4">
                    ...
                    @endif
                    <p class="font-bold text-primary pt-4">Salam Excellent!<br>— {{ $leaderName }} (<span data-id="Direktur" data-en="Director">Direktur</span>)</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="px-5 md:px-16 max-w-[1280px] mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 justify-center">
                <div class="group text-center mx-auto md:col-start-2" data-reveal="zoom-in">
                    ...
                    <h3 class="text-[20px] font-semibold font-serif text-text-light mb-1">{{ $leaderName }}</h3>
                    <p class="text-[0.7rem] uppercase tracking-[0.15em] font-semibold text-primary mb-3"><span data-id="{{ $leaderTitle }}" data-en="{{ $leaderTitle }}">{{ $leaderTitle }}</span></p>
                    <p class="text-sm text-muted-light leading-relaxed"><span data-id="{{ $leaderBio }}" data-en="{{ $leaderBio }}">{{ $leaderBio }}</span></p>
                </div>
            </div>
        </div>
    </section>
