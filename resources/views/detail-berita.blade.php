...
@section('content')
        ...
        <div class="relative z-20 px-6 max-w-5xl mx-auto pt-24 text-white" data-reveal="fade-up">
            ...
            <div class="flex items-center justify-center gap-4 text-white/80 text-sm">
                ...
                <span class="flex items-center gap-1.5" id="views-count-display">
                    ...
                    <span id="views-count-num">{{ number_format($article->views_count) }}</span> views
                </span>
            </div>
        </div>
    </section>
    ...
    {{-- Share Modal (outside article to avoid clipping) --}}
    <div id="share-modal" style="position:fixed;inset:0;z-index:9998;opacity:0;visibility:hidden;transition:opacity 0.3s ease;">
        ...
        <div id="share-modal-content" style="position:absolute;bottom:0;left:0;right:0;background:#1a1a1a;border-radius:1.5rem 1.5rem 0 0;padding:2rem 1.5rem 2.5rem;transform:translateY(100%);transition:transform 0.35s cubic-bezier(0.4,0,0.2,1);">
            ...
            <div style="display:flex;justify-content:center;gap:1.25rem;flex-wrap:wrap;">
                ...
                {{-- Facebook --}}
                <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url('/berita/' . $article->slug)) }}" target="_blank" rel="noopener" style="display:flex;flex-direction:column;align-items:center;gap:0.5rem;text-decoration:none;">
                ...
                {{-- X (Twitter) --}}
                <a href="https://twitter.com/intent/tweet?url={{ urlencode(url('/berita/' . $article->slug)) }}&text={{ urlencode($article->title) }}" target="_blank" rel="noopener" style="display:flex;flex-direction:column;align-items:center;gap:0.5rem;text-decoration:none;">
                ...
                {{-- WhatsApp --}}
                <a href="https://wa.me/?text={{ urlencode($article->title . ' — ' . url('/berita/' . $article->slug)) }}" target="_blank" rel="noopener" style="display:flex;flex-direction:column;align-items:center;gap:0.5rem;text-decoration:none;">
                ...
                {{-- Line --}}
                <a href="https://social-plugins.line.me/lineit/share?url={{ urlencode(url('/berita/' . $article->slug)) }}" target="_blank" rel="noopener" style="display:flex;flex-direction:column;align-items:center;gap:0.5rem;text-decoration:none;">
                ...
                {{-- Telegram --}}
                <a href="https://t.me/share/url?url={{ urlencode(url('/berita/' . $article->slug)) }}&text={{ urlencode($article->title) }}" target="_blank" rel="noopener" style="display:flex;flex-direction:column;align-items:center;gap:0.5rem;text-decoration:none;">
