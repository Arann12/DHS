...
@section('title', 'Editor Form Layanan & Beasiswa')
@section('page-title', 'Editor Lengkap Halaman Pengajuan Layanan & Beasiswa')
...
<div x-data="layananSettingsCompleteData()">
    ...
    {{-- TAB 2: PILIHAN BEASISWA & DOKUMEN --}}
