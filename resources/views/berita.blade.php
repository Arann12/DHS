...
@section('content')
    ...
    <section class="max-w-[1280px] mx-auto px-5 md:px-16 pt-4 pb-20">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <a href="/berita/{{ $article->slug }}" class="bg-white overflow-hidden shadow-sm flex flex-col group cursor-pointer hover:shadow-md transition-shadow border border-black/5">
