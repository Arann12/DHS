...
function brandingCompleteData() {
    return {
        ...
        colors: [
            { key:'color_primary',   name:'DHS Royal Blue (Dominan)', value:'<?php echo e($settings["color_primary"]->setting_value ?? "#1A365D"); ?>' },
            { key:'color_navy',      name:'Dark Navy (Header/Sidebar)', value:'<?php echo e($settings["color_navy"]->setting_value ?? "#0F2440"); ?>' },
            { key:'color_secondary', name:'DHS Red (Aksen/Tombol)',     value:'<?php echo e($settings["color_secondary"]->setting_value ?? "#C53030"); ?>' },
            { key:'color_gold',      name:'DHS Gold (Aksen Premium)',   value:'<?php echo e($settings["color_gold"]->setting_value ?? "#C53030"); ?>' },
            { key:'color_cream',     name:'Light Gray (Background)',    value:'<?php echo e($settings["color_cream"]->setting_value ?? "#F7FAFC"); ?>' },
            { key:'color_beige',     name:'Light Blue (Section)',       value:'<?php echo e($settings["color_beige"]->setting_value ?? "#EBF4FF"); ?>' }
        ],
        fonts: {
