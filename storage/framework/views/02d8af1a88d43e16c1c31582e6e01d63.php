...
function galeriData() {
    return {
        dragOver: false,
        items: <?php echo json_encode($galleries->map(fn($g) => [
            'id'    => $g->id, 'src'   => $g->image_url, 'name'  => $g->title ?: 'Foto Kampus') ?>,
...
<?php echo $__env->make('backoffice.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\DHS\resources\views/backoffice/galeri.blade.php ENDPATH**/ ?>