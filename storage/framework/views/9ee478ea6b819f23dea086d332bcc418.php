...
<?php $__env->startSection('content'); ?>
    ...
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:18px;margin-bottom:28px;">
        ...
        <div class="bo-card" style="border-left:4px solid #0E06B4;padding:20px 24px;">
            ...
            <div style="font-family:'Playfair Display',serif;font-size:34px;font-weight:700;color:#2B2494;line-height:1;"><?php echo e($stats['berita']); ?></div>
        ...
        <div class="bo-card" style="border-left:4px solid #16a34a;padding:20px 24px;">
            ...
            <div style="font-family:'Playfair Display',serif;font-size:34px;font-weight:700;color:#2B2494;line-height:1;"><?php echo e($stats['program']); ?></div>
        ...
        <div class="bo-card" style="border-left:4px solid #f59e0b;padding:20px 24px;">
            ...
            <div style="font-family:'Playfair Display',serif;font-size:34px;font-weight:700;color:#2B2494;line-height:1;"><?php echo e($stats['pendaftar']); ?></div>
        ...
        <div class="bo-card" style="border-left:4px solid #E10001;padding:20px 24px;">
            ...
            <div style="font-family:'Playfair Display',serif;font-size:34px;font-weight:700;color:#2B2494;line-height:1;"><?php echo e($stats['users']); ?></div>
        ...
        <div class="bo-card">
            ...
            <table class="bo-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div style="font-weight:600;color:#1a1a2e;"><?php echo e(Str::limit($item->title, 50)); ?></div>
                        </td>
                        <td><span class="badge badge-blue"><?php echo e(ucfirst($item->category)); ?></span></td>
                        <td style="color:#8A8478;font-size:13px;"><?php echo e($item->created_at->format('d M Y')); ?></td>
                        <td>
                ...
                <div style="display:flex;flex-direction:column;gap:14px;">
                    ...
                    <div style="display:flex;gap:12px;align-items:flex-start;">
                        ...
                        <div>
                            ...
                            <div style="font-size:12px;color:#8A8478;margin-top:2px;"><?php echo e(\Carbon\Carbon::parse($act->created_at)->diffForHumans()); ?></div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
