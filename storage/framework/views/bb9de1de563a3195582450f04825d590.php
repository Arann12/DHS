<nav id="main-nav"
    ...
    <div class="hidden md:flex items-center justify-start space-x-8 text-xs font-light tracking-wide flex-1">
        <a class="nav-link hover:opacity-70 transition-opacity <?php echo e(Request::is('/') ? 'nav-link-active' : ''); ?>"
            href="/"><span data-id="Beranda" data-en="Home">Beranda</span></a>
        <a class="nav-link hover:opacity-70 transition-opacity <?php echo e(Request::is('tentang-kami') ? 'nav-link-active' : ''); ?>"
            href="/tentang-kami"><span data-id="Tentang Kami" data-en="About Us">Tentang Kami</span></a>
        <a class="nav-link hover:opacity-70 transition-opacity <?php echo e(Request::is('akademi') ? 'nav-link-active' : ''); ?>"
    ...
    <a class="nav-logo absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center justify-center focus:outline-none transition-transform hover:scale-105"
        href="/">
        <img src="<?php echo e(isset($navLogo) ? asset(ltrim($navLogo, '/')) : asset('image/LogoDHS.png')); ?>" alt="Logo DHS"
    ...
    <div class="hidden md:flex items-center justify-end space-x-8 text-xs font-light tracking-wide flex-1">
        <a class="nav-link hover:opacity-70 transition-opacity <?php echo e(Request::is('berita') ? 'nav-link-active' : ''); ?>"
            href="/berita"><span data-id="Berita" data-en="News">Berita</span></a>
        <a class="nav-link hover:opacity-70 transition-opacity <?php echo e(Request::is('faq') ? 'nav-link-active' : ''); ?>"
            href="/faq"><span data-id="FAQ" data-en="FAQ">FAQ</span></a>
        <a class="nav-link hover:opacity-70 transition-opacity <?php echo e(Request::is('formulir-pendaftaran') ? 'nav-link-active' : ''); ?>"
...
</script><?php /**PATH D:\laragon\www\DHS\resources\views/partials/nav.blade.php ENDPATH**/ ?>