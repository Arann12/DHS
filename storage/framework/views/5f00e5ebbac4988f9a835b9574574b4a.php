...
<?php $__env->startSection('page-title', 'FAQ (Pertanyaan Umum)'); ?>
...
function faqData() {
    return {
        search: '',
        filterKategori: '',
        items: <?php echo json_encode($faqList, 15, 512) ?>,
...
<?php echo $__env->make('backoffice.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\DHS\resources\views\backoffice\faq.blade.php ENDPATH**/ ?>