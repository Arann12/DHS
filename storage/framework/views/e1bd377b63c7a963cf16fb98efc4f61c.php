    ...
    <section class="border-y border-black/10 bg-dhs-cream">
        <div class="max-w-[1280px] mx-auto px-5 md:px-16 py-4">
            <div class="flex overflow-x-auto gap-4 md:justify-center">
                ...
                <button class="faq-cat-btn whitespace-nowrap px-6 py-2 bg-transparent text-text-light hover:bg-dhs-beige text-[0.7rem] uppercase tracking-[0.15em] font-semibold border border-transparent hover:border-black/20 transition-colors" data-cat="<?php echo e($cat); ?>">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-white p-6 shadow-sm border border-transparent hover:border-black/10 transition-colors faq-item" data-question="<?php echo e(strtolower($faq->question)); ?>">
                        ...
                        <div class="accordion-content overflow-hidden transition-all duration-300 max-h-0">
                            <div class="text-muted-light text-base leading-relaxed pt-4"><?php echo strip_tags($faq->answer, '<p><b><i><u><strong><em><ul><ol><li><a><br><h3><h4>'); ?></div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
