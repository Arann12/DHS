...
<div x-data="aboutUsCompleteData()">
    ...
    <div x-show="activeTab === 'hero'">
        <div class="bo-card" style="max-width:750px;">
            <h2 style="font-family:'Playfair Display',serif;font-size:18px;color:#0F2440;margin:0 0 20px;">1. Hero Banner About Us</h2>
    ...
    <div x-show="activeTab === 'intro'">
        <div class="bo-card" style="max-width:800px;">
            <h2 style="font-family:'Playfair Display',serif;font-size:18px;color:#0F2440;margin:0 0 20px;">2. Tagline & Intro</h2>
            <div class="form-group">
    ...
    <div x-show="activeTab === 'vision'">
        <div class="bo-grid-2" style="display:grid;grid-template-columns:1fr 1fr;gap:24px;">
            <div style="display:flex;flex-direction:column;gap:20px;">
                ...
                <div class="bo-card">
                    <h2 style="font-family:'Playfair Display',serif;font-size:18px;color:#0F2440;margin:0 0 16px;">
                        <input type="text" class="bo-input" style="font-family:'Playfair Display',serif;font-size:18px;color:#0F2440;border:none;padding:0;background:transparent;" x-model="vision.visiLabel" placeholder="Visi">
                    </h2>
                    <textarea class="bo-textarea" rows="3" x-model="vision.visi"></textarea>
                </div>
                <div class="bo-card">
                    <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;">
                        <h2 style="font-family:'Playfair Display',serif;font-size:18px;color:#0F2440;margin:0;">
                            <input type="text" class="bo-input" style="font-family:'Playfair Display',serif;font-size:18px;color:#0F2440;border:none;padding:0;background:transparent;width:120px;" x-model="vision.misiLabel" placeholder="Misi">
                        </h2>
            ...
            <div class="bo-card">
                <h2 style="font-family:'Playfair Display',serif;font-size:18px;color:#0F2440;margin:0 0 16px;">Core Values</h2>
    ...
    <div x-show="activeTab === 'timeline'">
        <div class="bo-card" style="max-width:850px;">
            ...
            <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:20px;">
                <h2 style="font-family:'Playfair Display',serif;font-size:18px;color:#0F2440;margin:0;">Milestone Timeline</h2>
    ...
    <div x-show="activeTab === 'leadership'">
        <div class="bo-grid-2" style="display:grid;grid-template-columns:1fr 1fr;gap:24px;">
            <div class="bo-card">
                <h2 style="font-family:'Playfair Display',serif;font-size:18px;color:#0F2440;margin:0 0 16px;">Kata Sambutan Direktur</h2>
                <div class="form-group">
                    <label class="bo-label">Paragraf 1</label>
            ...
            <div class="bo-card" style="grid-column:1/-1;">
                <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px;">
                    <h2 style="font-family:'Playfair Display',serif;font-size:18px;color:#0F2440;margin:0;">Tim Kepemimpinan</h2>
                ...
                <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(220px,1fr));gap:16px;" x-show="leaderTeam.length > 0">
                    <template x-for="(member, idx) in leaderTeam" :key="idx">
                        <div style="border:1px solid #e5e7eb;border-radius:12px;padding:16px;text-align:center;background:#fafafa;">
                            ...
                            <p style="font-size:11px;color:#0F2440;font-weight:600;text-transform:uppercase;letter-spacing:.05em;margin:0 0 8px;" x-text="member.title"></p>
                            <p style="font-size:11px;color:#718096;margin:0 0 12px;line-height:1.5;" x-text="member.bio"></p>
                ...
                <p style="color:#718096;font-size:13px;text-align:center;padding:20px 0;" x-show="leaderTeam.length === 0">
                ...
                <div x-show="leaderModal.open" style="position:fixed;inset:0;z-index:9999;background:rgba(0,0,0,0.5);display:flex;align-items:center;justify-content:center;padding:20px;" @click.self="leaderModal.open=false">
                    <div style="background:#fff;border-radius:16px;padding:28px;width:100%;max-width:480px;box-shadow:0 20px 60px rgba(0,0,0,.2);">
                        <h3 style="font-family:'Playfair Display',serif;font-size:18px;color:#0F2440;margin:0 0 20px;" x-text="leaderModal.mode==='add' ? 'Tambah Anggota Tim' : 'Edit Anggota Tim'"></h3>

                        <div class="form-group">
                            <label class="bo-label">Nama Lengkap & Gelar <span style="color:#C53030">*</span></label>
    ...
    <div x-show="activeTab === 'cta'">
        <div class="bo-card" style="max-width:700px;">
            <h2 style="font-family:'Playfair Display',serif;font-size:18px;color:#0F2440;margin:0 0 20px;">6. CTA Bottom Banner</h2>
            <div class="form-group">
