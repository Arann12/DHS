<?php $__env->startSection('title', 'Data Pendaftaran Online'); ?>
<?php $__env->startSection('page-title', 'Data Pendaftaran Online (Registrasi Baru)'); ?>
...
function pendaftarData() {
    return {
        ...
        savedMessage: '',
        selectedItem: null,
        items: <?php echo json_encode($initialData, 15, 512) ?>,
        get filteredItems() {
...
<?php echo $__env->make('backoffice.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\DHS\resources\views/backoffice/pendaftar.blade.php ENDPATH**/ ?>