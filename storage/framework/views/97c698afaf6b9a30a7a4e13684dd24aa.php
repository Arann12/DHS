...
<style>
    ...
    .testimonial-section::before {
        ...
        width: 400px;
        height: 400px;
        background: radial-gradient(circle, rgba(197,48,48,0.04) 0%, transparent 70%);
        border-radius: 50%;
        pointer-events: none;
    }
    ...
    .testimonial-card {
        ...
        box-shadow: 0 24px 64px rgba(0,0,0,0.07), 0 4px 16px rgba(197,48,48,0.05);
        text-align: center;
        position: absolute;
        top: 0;
        left: 0;
    ...
    .slider-arrow:hover {
        ...
        box-shadow: 0 8px 24px rgba(197,48,48,0.25);
    }
...
<?php endif; ?>
<?php /**PATH D:\laragon\www\DHS\resources\views/components/testimonial-slider.blade.php ENDPATH**/ ?>