...
<?php $__env->startSection('content'); ?>
    ...
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:18px;margin-bottom:28px;">
        ...
        <div class="bo-card" style="border-left:4px solid #1A1F6B;padding:20px 24px;">
            ...
            <div style="font-family:'Playfair Display',serif;font-size:34px;font-weight:700;color:#101340;line-height:1;"><?php echo e($stats['berita']); ?></div>
        ...
        <div class="bo-card" style="border-left:4px solid #16a34a;padding:20px 24px;">
            ...
            <div style="font-family:'Playfair Display',serif;font-size:34px;font-weight:700;color:#101340;line-height:1;"><?php echo e($stats['program']); ?></div>
        ...
        <div class="bo-card" style="border-left:4px solid #f59e0b;padding:20px 24px;">
            ...
            <div style="font-family:'Playfair Display',serif;font-size:34px;font-weight:700;color:#101340;line-height:1;"><?php echo e($stats['pendaftar']); ?></div>
        ...
        <div class="bo-card" style="border-left:4px solid #D4302A;padding:20px 24px;">
            ...
            <div style="font-family:'Playfair Display',serif;font-size:34px;font-weight:700;color:#101340;line-height:1;"><?php echo e($stats['users']); ?></div>
