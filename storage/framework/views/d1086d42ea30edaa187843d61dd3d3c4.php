<?php $__env->startSection('title', 'FAQ — Denpasar Hotel School'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="border-y border-black/10 bg-dhs-lightblue">
        <div class="max-w-[1280px] mx-auto px-5 md:px-16 py-4">
            <div class="flex overflow-x-auto gap-4 md:justify-center">
                ...
                ?>
                <?php $__currentLoopData = $faqs->keys(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <button class="faq-cat-btn whitespace-nowrap px-6 py-2 bg-transparent text-text-light hover:bg-dhs-lightblue text-[0.7rem] uppercase tracking-[0.15em] font-semibold border border-transparent hover:border-black/20 transition-colors" data-cat="<?php echo e($cat); ?>">
                    <span><?php echo e($categoryLabels[$cat] ?? ucfirst($cat)); ?></span></button>
    ...
    <section class="px-5 md:px-16 py-16 md:py-20 max-w-[1280px] mx-auto">
        <div class="max-w-3xl mx-auto space-y-16">
            <?php $__empty_1 = true; $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div data-section="<?php echo e($category); ?>">
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-white p-6 shadow-sm border border-transparent hover:border-black/10 transition-colors faq-item" data-question="<?php echo e(strtolower($faq->question)); ?>">
                        <button class="w-full flex justify-between items-center text-left focus:outline-none accordion-toggle">
                            <span class="text-[20px] font-semibold text-text-light pr-4"><?php echo e($faq->question); ?></span>
                        ...
                        <div class="accordion-content overflow-hidden transition-all duration-300 max-h-0">
                            <div class="text-muted-light text-base leading-relaxed pt-4"><?php echo strip_tags($faq->answer, '<p><b><i><u><strong><em><ul><ol><li><br><h3><h4>'); ?></div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
        ...
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                <a class="inline-flex items-center justify-center px-8 py-4 bg-primary text-white text-[0.7rem] uppercase tracking-[0.15em] font-semibold hover:bg-primary/90 transition-colors w-full sm:w-auto min-w-[280px]"
                    href="https://wa.me/<?php echo e($waNumber); ?>" target="_blank">
                    Hubungi Kami via WhatsApp (<?php echo e($helpdeskWA); ?>)
                </a>
                <a class="inline-flex items-center justify-center px-8 py-4 bg-transparent border border-dhs-navy text-dhs-navy text-[0.7rem] uppercase tracking-[0.15em] font-semibold hover:bg-dhs-navy hover:text-white transition-colors w-full sm:w-auto min-w-[280px]"
                    href="mailto:<?php echo e($helpdeskEmail); ?>">
                    Kirim Pertanyaan via Email (<?php echo e($helpdeskEmail); ?>)
                </a>
            </div>
        </div>
    </section>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\DHS\resources\views\faq.blade.php ENDPATH**/ ?>