...
function usersData() {
    return {
        search: '',
        items: <?php echo json_encode($users->map(fn($u) => [
            'id'       => $u->id, 'nama'     => $u->name, 'username' => $u->username ?? explode('@') ?>,
...
<?php echo $__env->make('backoffice.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\DHS\resources\views\backoffice\users.blade.php ENDPATH**/ ?>