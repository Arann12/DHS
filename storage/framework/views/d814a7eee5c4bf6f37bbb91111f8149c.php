        ...
        <div class="px-5 md:px-16 max-w-[1280px] mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                ...
                <div class="bg-dhs-lightblue p-10 shadow-sm" data-reveal="fade-left" data-delay="200">
                    ...
                    <h3 class="text-[24px] font-semibold font-serif text-text-light mb-4"><span data-id="Misi" data-en="Mission"><?php echo e($visionMisiLabel); ?></span></h3>
    ...
    <section class="bg-dhs-lightblue py-20 md:py-24 px-5 md:px-16">
        <div class="max-w-3xl mx-auto text-center" data-reveal="zoom-in">
            ...
            <div class="flex flex-col sm:flex-row justify-center gap-4" data-reveal="fade-up" data-delay="200">
                ...
                <a class="px-8 py-4 bg-transparent border border-dhs-navy text-dhs-navy text-[0.7rem] uppercase tracking-[0.15em] font-semibold hover:bg-dhs-navy hover:text-white transition-colors" href="<?php echo e($ctaBtn2Url); ?>"><span data-id="Daftar Sekarang" data-en="Register Now"><?php echo e($ctaBtn2); ?></span></a>
            </div>
        </div>
    </section>
