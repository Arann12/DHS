...
<?php $__env->startSection('page-title', 'Berita & Artikel'); ?>
...
function beritaData() {
    return {
        search: '',
        filterStatus: '',
        items: <?php echo json_encode($articlesData, 15, 512) ?>,
        ...
        saveItem() {
            ...
            fetch(url, { method: 'POST', body: formData, headers: { 'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>' } })
...
<?php echo $__env->make('backoffice.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\DHS\resources\views/backoffice/berita.blade.php ENDPATH**/ ?>