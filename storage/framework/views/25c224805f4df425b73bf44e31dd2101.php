<?php $__env->startSection('title', 'Editor Registration Form & Admisi'); ?>
<?php $__env->startSection('page-title', 'Editor Lengkap Halaman Registration Form & Admisi'); ?>
...
function admisiCompleteData() {
    return {
        ...
        contact: {
            wa: '<?php echo e($helpdesk["helpdesk_wa"] ?? "+62 81 246 319966"); ?>',
            email: '<?php echo e($helpdesk["helpdesk_email"] ?? "sahabat@dhs.or.id"); ?>',
            hours: '<?php echo e($helpdesk["helpdesk_hours"] ?? "Senin – Sabtu: 08:00 – 17:00 WITA"); ?>'
        },
        saveAll() {
...
<?php echo $__env->make('backoffice.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\laragon\www\DHS\resources\views\backoffice\admisi.blade.php ENDPATH**/ ?>